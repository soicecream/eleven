...
!function (t, e) {
    ...
    function m(t) {
        ...
        return o || (e = n.body.appendChild(n.createElement(i)), o = gt.css(e, "display"), e.parentNode.removeChild(e), "none" === o && (o = "block"), _t[i] = o, o)
    }
    ...
    function x(t, e, n, i, o) {
        ...
        for (p.textContent = "", f = 0; r = h[f++];) if (i && gt.inArray(r, i) > -1) o && o.push(r); else if (l = gt.contains(r.ownerDocument, r), s = y(p.appendChild(r), "script"), l && b(s), n) for (c = 0; r = s[c++];) zt.test(r.type || "") && n.push(r);
        return p
    }
    ...
    function M(t, e, i, o) {
        ...
        if (h && (r = x(e, t[0].ownerDocument, !1, t, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
    ...
    function j(t, e, n) {
        for (var i, o = e ? gt.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || gt.cleanData(y(i)), i.parentNode && (n && gt.contains(i.ownerDocument, i) && b(y(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    ...
    function P(t) {
        var e = gt.cssProps[t];
        return e || (e = gt.cssProps[t] = R(t) || t), e
    }
    ...
    function I(t, e, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
            "margin" === n && (s += gt.css(t, n + Ft[r], !0, o)),
                i ? ("content" === n && (s -= gt.css(t, "padding" + Ft[r], !0, o)), "margin" !== n && (s -= gt.css(t, "border" + Ft[r] + "Width", !0, o))) :
                    (s += gt.css(t, "padding" + Ft[r], !0, o), "padding" !== n && (s += gt.css(t, "border" + Ft[r] + "Width", !0, o)));
        return s
    }
    ...
    function z(t, e, n) {
        var i, o, r, s, a, u, l, c, p = "width" in e || "height" in e, h = this, f = {}, d = t.style,
            g = t.nodeType && Ot(t), m = Lt.get(t, "fxshow");
    ...
    function Y(t, e, n) {
        var i, o, r = 0, s = Y.prefilters.length, a = gt.Deferred().always(function () {
            ...
            if (o) return !1;
            for (var e = ce || _(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, r = 1 - i, s = 0, u = l.tweens.length; s < u; s++) l.tweens[s].run(r);
    ...
    var et = [], nt = t.document, it = Object.getPrototypeOf, ot = et.slice, rt = et.concat, st = et.push,
        at = et.indexOf, ut = {}, lt = ut.toString, ct = ut.hasOwnProperty, pt = ct.toString, ht = pt.call(Object),
        ft = {}, dt = "3.2.1", gt = function (t, e) {
    ...
    var vt = function (t) {
        function e(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : O) !== j && M(e), e = e || j, $)) {
                if (11 !== d && (u = gt.exec(t))) if (o = u[1]) {
                    ...
                    if ((o = u[3]) && x.getElementsByClassName && e.getElementsByClassName) return G.apply(n, e.getElementsByClassName(o)), n
                }
                if (x.qsa && !z[t + " "] && (!R || !R.test(t))) {
                    if (1 !== d) f = e, h = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(bt, xt) : e.setAttribute("id", a = F), c = S(t), r = c.length; r--;) c[r] = "#" + a + " " + p(c[r]);
        ...
        function h(t, e, n) {
            var i = e.dir, o = e.next, r = o || i, s = n && "parentNode" === r, a = _++;
        ...
        function m(t, e, n, o, r, s) {
            return o && !o[F] && (o = m(o)), r && !r[F] && (r = m(r, s)), i(function (i, s, a, u) {
                var l, c, p, h = [], f = [], m = s.length, v = i || d(e || "*", a.nodeType ? [a] : a, []),
                    y = !t || !i && e ? v : g(v, h, t, a, u), b = n ? r || (i ? t : m || o) ? [] : s : y;
                if (n && n(y, b, a, u), o) for (l = g(b, f), o(l, [], a, u), c = l.length; c--;) (p = l[c]) && (b[f[c]] = !(y[f[c]] = p));
                if (i) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (c = b.length; c--;) (p = b[c]) && (l = r ? K(i, p) : h[c]) > -1 && (i[l] = !(s[l] = p))
                    }
                } else b = g(b === s ? b.splice(m, b.length) : b), r ? r(null, s, b, u) : G.apply(s, b)
            })
        }
        ...
        function y(t, n) {
            var o = n.length > 0, r = t.length > 0, s = function (i, s, a, u, l) {
                var c, p, h, f = 0, d = "0", m = i && [], v = [], y = k, b = i || r && T.find.TAG("*", l),
                    x = H += null == y ? 1 : Math.random() || .1, w = b.length;
                for (l && (k = s === j || s || l); d !== w && null != (c = b[d]); d++) {
                    if (r && c) {
        ...
        var b, x, T, w, C, S, E, A, k, D, N, M, j, L, $, R, P, q, I, F = "sizzle" + 1 * new Date, O = t.document, H = 0,
            _ = 0, W = n(), B = n(), z = n(), X = function (t, e) {
                return t === e && (N = !0), 0
            ...
            ut = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]", "g"), lt = new RegExp(it),
            ct = new RegExp("^" + et + "$"), pt = {
                ID: new RegExp("^#(" + et + ")"),
                CLASS: new RegExp("^\\.(" + et + ")"),
                TAG: new RegExp("^(" + et + "|[*])"),
            ...
            }, ht = /^(?:input|select|textarea|button)$/i, ft = /^h\d$/i, dt = /^[^{]+\{\s*\[native \w/,
            gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/,
        ...
        x = e.support = {}, C = e.isXML = function (t) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, L = j.documentElement, $ = !C(j), O !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), x.attributes = o(function (t) {
            ...
            }, P = [], R = [], (x.qsa = dt.test(j.querySelectorAll)) && (o(function (t) {
                ...
                e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && R.push("name" + tt + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && R.push(":enabled", ":disabled"), L.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && R.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), R.push(",.*:")
            })), (x.matchesSelector = dt.test(q = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && o(function (t) {
                x.disconnectedMatch = q.call(t, "*"), q.call(t, "[s!='']:x"), P.push("!=", it)
            }), R = R.length && new RegExp(R.join("|")), P = P.length && new RegExp(P.join("|")), e = dt.test(L.compareDocumentPosition), I = e || dt.test(L.contains) ? function (t, e) {
                ...
                return n || (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === j || t.ownerDocument === O && I(O, t) ? -1 : e === j || e.ownerDocument === O && I(O, e) ? 1 : D ? K(D, t) - K(D, e) : 0 : 4 & n ? -1 : 1)
            } : function (t, e) {
                if (t === e) return N = !0, 0;
            ...
            if ((t.ownerDocument || t) !== j && M(t), n = n.replace(ut, "='$1']"), x.matchesSelector && $ && !z[n + " "] && (!P || !P.test(n)) && (!R || !R.test(n))) try {
                var i = q.call(t, n);
            ...
            var e, n = [], i = 0, o = 0;
            if (N = !x.detectDuplicates, D = !x.sortStable && t.slice(0), t.sort(X), N) {
            ...
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === i && 0 === o ? function (t) {
                        ...
                        var l, c, p, h, f, d, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode,
                        ...
                        if (m) {
                            ...
                            if (d = [s ? m.firstChild : m.lastChild], s && y) {
                                for (h = m, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], b = f && l[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (b = f = 0) || d.pop();) if (1 === h.nodeType && ++b && h === e) {
                                    c[t] = [H, f, b];
                                    break
                                }
                            } else if (y && (h = e, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], b = f), !1 === b) for (; (h = ++f && h && h[g] || (b = f = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), c[t] = [H, b]), h !== e));) ;
        ...
        }, x.sortStable = F.split("").sort(X).join("") === F, x.detectDuplicates = !!N, M(), x.sortDetached = o(function (t) {
    ...
    var yt = function (t, e, n) {
            ...
            return n
        }, xt = gt.expr.match.needsContext, Tt = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
        wt = /^.[^:#\[\.,]*$/;
    gt.filter = function (t, e, n) {
        ...
        find: function (t) {
            ...
            return !!r(this, "string" == typeof t && xt.test(t) ? gt(t) : t || [], !1).length
        }
    });
    var Ct, St = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    gt.fn.extend({
        has: function (t) {
            ...
            if (!xt.test(t)) for (; i < o; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && gt.find.matchesSelector(n, t))) {
                r.push(n);
                break
            }
    ...
    var Lt = new h, $t = new h, Rt = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Pt = /[A-Z]/g;
    gt.extend({
        hasData: function (t) {
    ...
    var qt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, It = new RegExp("^(?:([+-])=|)(" + qt + ")([a-z%]*)$", "i"),
        Ft = ["Top", "Right", "Bottom", "Left"], Ot = function (t, e) {
    ...
    var Vt = nt.documentElement, Ut = /^key/, Qt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Gt = /^([^.]*)(?:\.(.+)|)/;
    gt.event = {
        global: {}, add: function (t, e, n, i, o) {
            ...
            var e, n, i, o, r, s, a = gt.event.fix(t), u = new Array(arguments.length),
                l = (Lt.get(this, "events") || {})[a.type] || [], c = gt.event.special[a.type] || {};
    ...
    var Jt = /<script|<style|<link/i, Kt = /checked\s*(?:[^=]|=\s*.checked.)/i, Zt = /^true\/(.*)/,
        te = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    gt.extend({
        htmlPrefilter: function (t) {
            ...
            return s = y(a, "script"), s.length > 0 && b(s, !u && y(t, "script")), a
    ...
    var ee = /^margin/, ne = new RegExp("^(" + qt + ")(?!px)[a-z%]+$", "i"), ie = function (e) {
    ...
    gt.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                return u || (e = P(a)), s = gt.cssHooks[e] || gt.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = It.exec(n)) && o[1] && (n = g(t, e, o), r = "number"), void (null != n && n === n && ("number" === r && (n += o && o[3] || (gt.cssNumber[a] ? "" : "px")), ft.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (u ? l.setProperty(e, n) : l[e] = n))))
            }
        },
        css: function (t, e, n, i) {
            var o, r, s, a = gt.camelCase(e);
            return re.test(e) || (e = P(a)), s = gt.cssHooks[e] || gt.cssHooks[a], s && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = L(t, e, i)), "normal" === o && e in ae && (o = ae[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
        ...
        gt.cssHooks[e] = {
            get: function (t, n, i) {
                ...
                return s && (o = It.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = gt.css(t, e)), q(t, n, s)
            }
        }
        ...
        }, ee.test(t) || (gt.cssHooks[t + e].set = q)
    }), gt.fn.extend({
        css: function (t, e) {
    ...
    gt.Animation = gt.extend(Y, {
        ...
        fadeTo: function (t, e, n, i) {
            ...
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, n = Lt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = gt.timers,
                    s = i ? i.length : 0;
    ...
    gt.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (t) {
                    var e, n, i, r = t.options, s = t.selectedIndex, a = "select-one" === t.type, u = a ? null : [],
                        l = a ? s + 1 : r.length;
    ...
    gt.extend(gt.event, {
        trigger: function (e, n, i, o) {
            var r, s, a, u, l, c, p, h = [i || nt], f = ct.call(e, "type") ? e.type : e,
    ...
    var be = t.location, xe = gt.now(), Te = /\?/;
    ...
    gt.param = function (t, e) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !gt(this).is(":disabled") && Se.test(this.nodeName) && !Ce.test(t) && (this.checked || !Wt.test(t))
            }).map(function (t, e) {
                var n = gt(this).val();
    ...
    var Ee = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ae = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
        ke = /^(?:GET|HEAD)$/, De = {}, Ne = {}, Me = "*/".concat("*"), je = nt.createElement("a");
    je.href = be.href, gt.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, n) {
            function i(e, n, i, a) {
                var l, h, f, x, T, w = n;
                c || (c = !0, u && t.clearTimeout(u), o = void 0, s = a || "", C.readyState = e > 0 ? 4 : 0, l = e >= 200 && e < 300 || 304 === e, i && (x = Z(d, C, i)), x = tt(d, x, C, l), l ? (d.ifModified && (T = C.getResponseHeader("Last-Modified"), T && (gt.lastModified[r] = T), (T = C.getResponseHeader("etag")) && (gt.etag[r] = T)), 204 === e || "HEAD" === d.type ? w = "nocontent" : 304 === e ? w = "notmodified" : (w = x.state, h = x.data, f = x.error, l = !f)) : (f = w, !e && w || (w = "error", e < 0 && (e = 0))), C.status = e, C.statusText = (n || w) + "", l ? v.resolveWith(g, [h, w, C]) : v.rejectWith(g, [C, w, f]), C.statusCode(b), b = void 0, p && m.trigger(l ? "ajaxSuccess" : "ajaxError", [C, d, l ? h : f]), y.fireWith(g, [C, w]), p && (m.trigger("ajaxComplete", [C, d]), --gt.active || gt.event.trigger("ajaxStop")))
            }

            "object" == typeof e && (n = e, e = void 0), n = n || {};
            var o, r, s, a, u, l, c, p, h, f, d = gt.ajaxSetup({}, n), g = d.context || d,
                m = d.context && (g.nodeType || g.jquery) ? gt(g) : gt.event, v = gt.Deferred(),
                y = gt.Callbacks("once memory"), b = d.statusCode || {}, x = {}, T = {}, w = "canceled", C = {
            ...
            if (v.promise(C), d.url = ((e || d.url || be.href) + "").replace(/^\/\//, be.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(kt) || [""], null == d.crossDomain) {
    ...
    gt.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = gt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Pe, "$1" + o) : !1 !== e.jsonp && (e.url += (Te.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return s || gt.error(o + " was not called"), s[0]
        }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === r ? gt(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, Re.push(o)), s && gt.isFunction(r) && r(s[0]), s = r = void 0
        }), "script"
        ...
        var i, o, r;
        return e || (ft.createHTMLDocument ? (e = nt.implementation.createHTMLDocument(""), i = e.createElement("base"), i.href = nt.location.href, e.head.appendChild(i)) : e = nt), o = Tt.exec(t), r = !n && [], o ? [e.createElement(o[1])] : (o = x([t], e, r), r && r.length && gt(r).remove(), gt.merge([], o.childNodes))
    ...
    return gt.noConflict = function (e) {
        return t.$ === gt && (t.$ = Ie), e && t.jQuery === gt && (t.jQuery = qe), gt
    }, e || (t.jQuery = t.$ = gt), gt
}), function (t, e) {
    function n(t, e, n) {
        var i = c[e.type] || {};
    ...
    h.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = h.style.backgroundColor.indexOf("rgba") > -1, f(l, function (t, e) {
        ...
        parse: function (o, s, a, c) {
            ...
            var i = u(t), o = i._space(), r = l[o], s = 0 === this.alpha() ? u("transparent") : this,
                a = s[r.cache] || r.to(s._rgba), p = a.slice();
        ...
        var e, n, i = t[0] / 255, o = t[1] / 255, r = t[2] / 255, s = t[3], a = Math.max(i, o, r),
            u = Math.min(i, o, r), l = a - u, c = a + u, p = .5 * c;
    ...
    o.initAngleGetterSetter = function () {
        ...
        var n = t * (Math.PI / 180), i = e * (Math.PI / 180), o = Math.atan2(Math.sin(n - i), Math.cos(n - i)),
            r = o * (180 / Math.PI);
    ...
    i.prototype.init = function () {
        ...
        var i = (this.$el.position(), this.velocity()), o = (this.dt, i.x / this.scale * this.options.multiplier),
            r = i.y / this.scale * this.options.multiplier, s = this.handleConstraint(o, r, !0);
    ...
    function e(t, e) {
        ...
        if ("random" === e.luminosity) return u([0, 100]);
        var n = s(t), i = n[0], o = n[1];
        switch (e.luminosity) {
            case"bright":
                i = 55;
                break;
    ...
    function i(t, e) {
        switch (e.format) {
            ...
            case"hsla":
                var i = f(t), o = e.alpha || Math.random();
                return "hsla(" + i[0] + ", " + i[1] + "%, " + i[2] + "%, " + o + ")";
            case"rgbArray":
                return p(t);
            case"rgb":
                return "rgb(" + p(t).join(", ") + ")";
            case"rgba":
                var r = p(t), o = e.alpha || Math.random();
    ...
    function o(t, e) {
        for (var n = a(t).lowerBounds, i = 0; i < n.length - 1; i++) {
            var o = n[i][0], r = n[i][1], s = n[i + 1][0], u = n[i + 1][1];
            if (e >= o && e <= s) {
                var l = (u - r) / (s - o);
                return l * e + (r - l * o)
            }
    ...
    function a(t) {
        ...
        for (var e in m) {
            var n = m[e];
            if (n.hueRange && t >= n.hueRange[0] && t <= n.hueRange[1]) return m[e]
        }
        return "Color not found"
    }

    function u(t) {
        if (null === g) return Math.floor(t[0] + Math.random() * (t[1] + 1 - t[0]));
        var e = t[1] || 1, n = t[0] || 0;
        g = (9301 * g + 49297) % 233280;
        var i = g / 233280;
        return Math.floor(n + i * (e - n))
    }
    ...
    function c(t, e, n) {
        var i = n[0][0], o = n[n.length - 1][0], r = n[n.length - 1][1], s = n[0][1];
        m[t] = {hueRange: e, lowerBounds: n, saturationRange: [i, o], brightnessRange: [r, s]}
    }

    function p(t) {
        var e = t[0];
        0 === e && (e = 1), 360 === e && (e = 359), e /= 360;
        var n = t[1] / 100, i = t[2] / 100, o = Math.floor(6 * e), r = 6 * e - o, s = i * (1 - n), a = i * (1 - r * n),
            u = i * (1 - (1 - r) * n), l = 256, c = 256, p = 256;
        switch (o) {
            case 0:
                l = i, c = u, p = s;
                break;
        ...
        return [Math.floor(255 * l), Math.floor(255 * c), Math.floor(255 * p)]
    }

    function h(t) {
        t = t.replace(/^#/, ""), t = 3 === t.length ? t.replace(/(.)/g, "$1$1") : t;
        const e = parseInt(t.substr(0, 2), 16) / 255, n = parseInt(t.substr(2, 2), 16) / 255,
            i = parseInt(t.substr(4, 2), 16) / 255, o = Math.max(e, n, i), r = o - Math.min(e, n, i), s = o ? r / o : 0;
        switch (o) {
            case e:
                return [(n - i) / r % 6 * 60 || 0, s, o];
            case n:
                return [60 * ((i - e) / r + 2) || 0, s, o];
            case i:
                return [60 * ((e - n) / r + 4) || 0, s, o]
        }
    }

    function f(t) {
        var e = t[0], n = t[1] / 100, i = t[2] / 100, o = (2 - n) * i;
        return [e, Math.round(n * i / (o < 1 ? o : 2 - o) * 1e4) / 100, o / 2 * 100]
    }
    ...
    var v = function (o) {
        ...
        if (null !== o.count && void 0 !== o.count) {
            var u = o.count, l = [];
            for (o.count = null; u > l.length;) g && o.seed && (o.seed += 1), l.push(v(o));
            return o.count = u, l
        }
        return r = t(o), s = e(r, o), a = n(r, s, o), i([r, s, a], o)
    };
    return v
});
